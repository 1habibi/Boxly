...
var Scroller = function ( dt, opts ) {
	...
	this.s = {
		 ...
		 * and when the user scrolls the viewport in orders to stop the cookie set taking too much
		 * CPU!
		 *  @type     int
		 *  @default  0
		 */
		 ...
		 * DataTables in orders to prevent DoSing the server
		 *  @type     int
		 *  @default  null
		 */
		drawTO: null,
...
$.extend( Scroller.prototype, {
	...
	*/
	...
	_draw: function ()
	{
			 ...
			 typeof this.s.dt.oLoadedState.scroller != 'undefined' )
		{
			     ...
			     (!ajaxSourced && this.s.dt.iDraw == 1) )
			{
				setTimeout( function () {
					...
					// In orders to prevent layout thrashing we need another
					// small delay
					setTimeout( function () {
		...
		// Because of the orders of the DT callbacks, the info update will
...
Scroller.defaults = {
	 ...
	 * typically does before you reach the end of the currently loaded data set (in orders to
