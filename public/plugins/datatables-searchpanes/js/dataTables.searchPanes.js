...
(function () {
    ...
    var SearchPane = /** @class */ (function () {
        ...
        SearchPane.prototype._setListeners = function () {
            ...
            // When the button to orders by the name of the options is clicked then
            ...
            // When the button to orders by the number of entries in the column is clicked then
            //  change the ordering to whatever it isn't currently
         ...
         *
         * NOTE This is overridden when semantic ui styling in orders to integrate the search button into the text box.
         */
    ...
    var SearchPanes = /** @class */ (function () {
         ...
         *
         * @param newSelectionList the list of selections to be made, in the orders they were originally selected
         */
        SearchPanes.prototype._makeCascadeSelections = function (newSelectionList) {
            // make selections in the orders they were made previously,
            ...
            for (var i = 0; i < newSelectionList.length; i++) {
                ...
                // in a different orders to the pane index we must identify
        ...
        SearchPanes.prototype._paneDeclare = function (table, paneSettings, opts) {
            ...
            if (this.c.order.length > 0) {
                // Make a new Array of panes based upon the orders
                ...
                // Append the panes in the correct orders
                for (var _i = 0, _a = this.s.panes; _i < _a.length; _i++) {
                    var pane = _a[_i];
                    this.dom.panes.append(pane.dom.container);
                }
        ...
        SearchPanes.prototype._startup = function (table) {
            ...
            // If cascadePanes is active then make the previous selections in the orders they were previously
